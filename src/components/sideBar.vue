<template>
    <div>
        <div class="sidebarbase">
            <li class="user-area">
                <div class="icon-user" @click="ShowUser()">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35.004" height="34.998" viewBox="0 0 35.004 34.998">
                        <path class="user_a" d="M17992.5,16622a17.5,17.5,0,1,1,12.375-5.125A17.385,17.385,0,0,1,17992.5,16622Zm-4.072-16.086a4.059,4.059,0,0,0-4.055,4.055v.506a1.523,1.523,0,0,0,1.523,1.52h13.172a1.52,1.52,0,0,0,1.518-1.52v-.506a4.059,4.059,0,0,0-4.055-4.055h-1.744a5.516,5.516,0,0,1-4.615,0Zm4.055-10.129a4.559,4.559,0,1,0,4.561,4.557A4.562,4.562,0,0,0,17992.482,16595.783Z" transform="translate(-17974.998 -16587)"/>
                    </svg>
                </div>
            </li>
            <li :class="classname == 'work' ? 'new-but-base-s' : 'but-base-s'" @click="Show('work')">
                <div class="cative-line" v-if="show == 'work'"></div>
                <div class="child">
                    <p>任務工作清單</p>
                </div>
                <div class="icon-s">
                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" >
                        <g transform="translate(-19 -169)">
                            <rect class="work_a" width="23" height="23" transform="translate(19 169)" />
                            <path class="work_b" d="M14228.2,16727a2.255,2.255,0,0,1-2.249-2.25v-13.5a2.251,2.251,0,0,1,2.249-2.25h2.6a3.6,3.6,0,0,1,7.1,0h2.9a2.25,2.25,0,0,1,2.248,2.25v13.5a2.254,2.254,0,0,1-2.248,2.25Zm-.749-15.748v13.5a.751.751,0,0,0,.749.75h12.6a.752.752,0,0,0,.75-.75v-13.5a.751.751,0,0,0-.75-.75h-3.607a.749.749,0,0,1-.545-.234.758.758,0,0,1-.205-.557l0-.061v-.051a2.1,2.1,0,1,0-4.2,0v.051l0,.061a.751.751,0,0,1-.749.791h-3.308A.75.75,0,0,0,14227.454,16711.248Zm2.661,11.563a.928.928,0,1,1,.93-.93.927.927,0,0,1-.93.93Zm3.038-.027a.9.9,0,0,1,0-1.8h5.7a.9.9,0,1,1,0,1.8Zm-3.038-3.855a.928.928,0,1,1,.93-.932.929.929,0,0,1-.93.932Zm3.038-.029a.9.9,0,0,1,0-1.8h5.7a.9.9,0,1,1,0,1.8Zm-3.038-3.932a.928.928,0,1,1,.93-.926.924.924,0,0,1-.93.926Zm3.038-.025a.9.9,0,0,1,0-1.8h5.7a.9.9,0,1,1,0,1.8Zm.152-5.346a1.05,1.05,0,1,1,1.051,1.049A1.048,1.048,0,0,1,14233.306,16709.6Z" transform="translate(-14203.955 -16535.996)"
                                  :style="style == 'work' ? getFill() : ''" />
                        </g>
                    </svg>
                </div>
            </li>
            <li :class="classname == 'pro' ? 'new-but-base-s' : 'but-base-s'"
                @click="Show('pro')" >
                <div class="cative-line" v-if="show == 'pro'"></div>
                <div class="child">
                    <p>專案設定</p>
                </div>
                <div class="icon-s">
...
<script>
    export default {
        ...
        methods: {
            ...
            Show: function (inder) {
                this.classname = inder
                this.show = inder
                this.style = inder
                let item = this.$store.state.functionList.find((item)=>item.type==inder)
                this.$store.commit('setNowFunc', item.component)
            },
            getFill() {
                return {fill: "#4481ff"};
            },
